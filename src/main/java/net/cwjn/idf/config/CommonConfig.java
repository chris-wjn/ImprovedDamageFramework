...
public class CommonConfig {
    ...
    static {
        ...
        BLACKLISTED_ENTITIES = BUILDER.comment("Entities that are blacklisted from the above list. Will not do anything if ''mob'' is not included in Whitelisted sources. Takes the registry name of a mob.")
